...
export default function Login({ setToken, setUsuario, onVoltarLanding }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 p-8 rounded-[2rem] shadow-2xl animate-fade-in relative z-10">
        
        {onVoltarLanding && (
          <button 
            type="button" 
            onClick={onVoltarLanding} 
            className="mb-6 text-xs text-slate-400 hover:text-white font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
          >
